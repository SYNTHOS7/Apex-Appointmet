(function() {
  ...
  var scriptTag = document.getElementById('ai-appointment-setter') || document.currentScript;
  ...
  // Read client identifier from data attribute
  var clientId = (scriptTag && scriptTag.getAttribute('data-client')) || 'default';
  var iframeUrl = origin + '/widget?clientId=' + encodeURIComponent(clientId);
